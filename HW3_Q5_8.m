...
for yy=1:length(zf)
 for bb=-63.5:1:63.5
        ...
        xf_pos_4(yy,bb+64.5)=xe_cont_pos_4(bb+64.5)*(3.5)*((anecoicCyst.elementSpacingMM)/1000);
...
for hh=1:128
    temp_cont_pos_4=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_pos_4(:,hh),'linear',0);
...
for yy=1:length(zf)
    ...
    for bb=-63.5:1:63.5
        ...
        xf_pos_1(yy,bb+64.5)=xe_cont_pos_1(bb+64.5)*(2.5)*((anecoicCyst.elementSpacingMM)/1000);
...
for hh=1:128
    temp_cont_pos_1=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_pos_1(:,hh),'linear',0);
...
for hh=1:128
    temp_cont_pos_2=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_pos_2(:,hh),'linear',0);
...
for bb=-63.5:1:63.5
        ...
        xf_pos_3(yy,bb+64.5)=xe_cont_pos_3(bb+64.5)*(.5)*((anecoicCyst.elementSpacingMM)/1000);
...
for hh=1:128
    temp_cont_pos_3=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_pos_3(:,hh),'linear',0);
...
for hh=1:128
    temp_cont_neg_1=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_neg_1(:,hh),'linear',0);
...
for hh=1:128
    temp_cont_neg_2=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_neg_2(:,hh),'linear',0);
...
for bb=-63.5:1:63.5
        ...
        xf_neg_3(yy,bb+64.5)=xe_cont_neg_3(bb+64.5)*(-2.5)*((anecoicCyst.elementSpacingMM)/1000);
...
for hh=1:128
    temp_cont_neg_3=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_neg_3(:,hh),'linear',0);
...
for bb=-63.5:1:63.5
        ...
        xf_neg_4(yy,bb+64.5)=xe_cont_neg_4(bb+64.5)*(-2.5)*((anecoicCyst.elementSpacingMM)/1000);
...
for hh=1:128
    temp_cont_neg_4=interp1(timeArray2(:,hh),squeeze(anecoicCyst_data(:,hh,1:8:128)),time_withDelays_cont_neg_4(:,hh),'linear',0);
...
figure;
imagesc(20*log10(abs(hilbert(zone_interp_cont_8))))
