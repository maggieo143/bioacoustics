...
for yy=1:length(zf)
    for bb=-63.5:1:63.5
        ...
        xf_pos_1(yy,bb+64.5)=xe_cont_pos_1(bb+64.5)*(.5)*((pointTarget.elementSpacingMM)/1000);
...
for hh=1:128
    temp_cont_pos_1=interp1(timeArray2(:,hh),squeeze(pointTarget_data(:,hh,1:4:128)),time_withDelays_cont_pos_1(:,hh),'linear',0);
...
for hh=1:128
    temp_cont_pos_2=interp1(timeArray2(:,hh),squeeze(pointTarget_data(:,hh,1:4:128)),time_withDelays_cont_pos_2(:,hh),'linear',0);
...
for hh=1:128
    temp_cont_neg_1=interp1(timeArray2(:,hh),squeeze(pointTarget_data(:,hh,1:4:128)),time_withDelays_cont_neg_1(:,hh),'linear',0);
...
for hh=1:128
    temp_cont_neg_2=interp1(timeArray2(:,hh),squeeze(pointTarget_data(:,hh,1:4:128)),time_withDelays_cont_neg_2(:,hh),'linear',0);
